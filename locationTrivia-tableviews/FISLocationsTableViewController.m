...
//
//  Created by Madina Ibrahim on 6/24/16.
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
   ...
   NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        FISTriviaTableViewController *newTriviaDestinationVC = (FISTriviaTableViewController *)segue.destinationViewController;
        newTriviaDestinationVC.triviaArray = [[self.locations objectAtIndex:indexPath.row]trivia];
    }
